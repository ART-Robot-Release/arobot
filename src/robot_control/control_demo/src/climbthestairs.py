...
class robotDemo:
    ...
    def move_to_start(self):
        ...
        point_start.time_from_start = rospy.Duration(2)
    ...
    def climbthestairs(self,tparam):
        time = 1
        msg = self.get_msg_with_name()
        point_start = JointTrajectoryPoint()
        point_start.positions = [0 for i in range(12)]
        ...
        time +=tparam  
        point= copy.deepcopy(point_start)
        self.move_left(point,15,-33,13,20,-15)
        self.move_right(point,15,0,0,0,-15)
        point.time_from_start = rospy.Duration(time)
        msg.points.append(point)
        ...
        point= copy.deepcopy(point_start)
        self.move_left(point,-15,-35,70,-35,15)
        self.move_right(point,-15,26,0,-26,15)
        point.time_from_start = rospy.Duration(time)
        msg.points.append(point)
...
if __name__ == '__main__':
    ...
    if do in ("climb", "climbthestairs"):
        pub.publish(demo.climbthestairs(5.0))
    elif do in ("reset"):
